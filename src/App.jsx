...
const projects = [
	{
		...
		detail: `
			...
			- **스타일링**: bootstrap과 커스텀 CSS를 조합해 반응형 UI 구현.
			- **주요 라이브러리**: react, redux, zustand, react-router-dom, axios, bootstrap.
			- **핵심 로직**: 
			- 상품 목록/상세/장바구니 상태를 Redux와 Zustand로 각각 구현해 비교.
	...
	},
	{
		...
		detail: `
			...
			- **주요 라이브러리**: react-native, axios, react-navigation, styled-components, openai.
			- **핵심 로직**:
